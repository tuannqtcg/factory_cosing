...
describe('pipe.ts — parity với tests/fixtures/pipe.json', () => {
  ...
  it('fullCostPerKg (bậc 3 thang giá — breakEvenFullCost) khớp số vàng 108.711,86 (ADR-019, v3.8)', () => {
    expect(cost.fullCostPerKg).toBeCloseTo(golden.fullCostPerKg, 6);
    expect(cost.fullCostPerKg).toBeCloseTo(108711.86314473968, 3);
  });

  it('vfPricePerKg (bậc 5 thang giá — targetPrice) khớp số vàng 135.889,83 (ADR-019, v3.8)', () => {
